...
#fintune no BOS loss version
no_BOS_ckpt="/data/tju/pretrained-weight/summary/gpt2_summarization_noBOS_-2_71778.ckpt"
...
echo ckpt_path: $no_BOS_ckpt>>$output_log
...
nohup python run_summarization_model.py  --device_target=$device --device_id=$device_id \
    ...
    --load_finetune_ckpt_path=$no_BOS_ckpt --eval_data_file_path=$datafile >> $output_log 2>&1 &
