...
def run_translation():
    ...
    parser.add_argument("--load_finetune_ckpt_path", type=str, default="/data/tju/pretrained-weight/mindspore_model_small.ckpt",
                        help="Load the checkpoint file path.")
    parser.add_argument("--train_data_file_path", type=str, default="/data/tju/src/mindspore-dataset/wmt14enfr-train-mindrecord",
                        help="Data path, it is better to use absolute path")
    parser.add_argument("--eval_data_file_path", type=str, default="/data/tju/src/mindspore-dataset/wmt14enfr-test-mindrecord",
                        help="Data path, it is better to use absolute path")
    ...
    if args_opt.do_eval.lower() == "true":
        ...
        do_eval(eval_dataset, GPT2Translation, metric, load_finetune_ckpt_path)
