...
def do_eval(dataset=None, metric=None, load_checkpoint_path=""):
    ...
    if metric.lower() == "accuracy":
        ...
        # print('start print net parameters:')
...
def run_languagemodel():
    ...
    parser.add_argument("--load_finetune_ckpt_path", type=str, default="./pretrained-weight/mindspore_model_small.ckpt",
                        help="Load the checkpoint file path.")
    parser.add_argument("--train_data_file_path", type=str, default="./src/mindspore-dataset/wikitext2-train-mindrecord",
                        help="Data path, it is better to use absolute path")
    parser.add_argument("--eval_data_file_path", type=str, default="./src/mindspore-dataset/wikitext2-test-mindrecord",
                        help="Data path, it is better to use absolute path")
