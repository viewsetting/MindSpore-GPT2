...
def modify_inputMask(input_mask,mode='remove_first_token'):

    batch_size = input_mask.shape[0]
    if mode == 'remove_first_token':
        input_mask_np = input_mask.asnumpy()

        for mask in input_mask_np:
            mask[0] = 0
        ...
        raise NotImplementedError('No mode called {} in src.utils.tensor_manipulations.modify_inputMask'.format(mode))