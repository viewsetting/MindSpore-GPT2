...
python create_data.py --input_file /datasets/cnn_dailymail/cnn_dailymail_train.txt --output_file /datasets/cnn_dailymail/cnn_dailymail-train_noBOS-mindrecord --num_splits 1 --max_seq_length 1024 --mode 'cnn_dailymail'
Translation:
