...
def do_train(dataset=None, network=None, load_checkpoint_path="", save_checkpoint_path="", epoch_num=1):
    ...
    model.train(epoch_num, dataset, callbacks=[time_cb, loss_cb, ckpoint_cb])
...
def do_eval(dataset=None, network=None, metric=None, load_checkpoint_path=""):
    ...
    if metric.lower() == "accuracy":
        model = Model(gpt2_loss, metrics={'acc': Accuracy()})
...
def run_languagemodel():
    ...
    if args_opt.do_train.lower() == "true":
        ...
        train_dataset = lm_train_dataset() # doing###
    ...
    if args_opt.do_eval.lower() == "true":
        ...
        eval_dataset = lm_eval_dataset() # doing###
